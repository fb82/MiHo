...
####
        ...
        [
            pipe_head,
            miho_duplex.miho_module(assign_jacobian=True),
            ncc.ncc_module(also_prev=True, ordstat=True),
            pipe_ransac
        ],
...
###
        ...
        [
            pipe_head,
            miho_duplex.miho_module(assign_jacobian=True),
            ncc.ncc_module(also_prev=True, use_covariance=True, ordstat=True),
            pipe_ransac
        ],
...
###
        ...
        [
            pipe_head,
            miho_duplex.miho_module(assign_jacobian=True),
            ncc.ncc_module(also_prev=True, use_covariance=True, search_gauss_mask=0.5, ordstat=True),
            pipe_ransac
        ],
...
###
        ...
        [
            pipe_head,
            miho_duplex.miho_module(assign_jacobian=True),
            ncc.ncc_module(also_prev=True, use_covariance=True, covariance_gauss_mask=0.5, ordstat=True),
            pipe_ransac
        ],

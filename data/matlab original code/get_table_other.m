...
out_file=[opath filesep 'report_other.tex'];
...
for ii=1:length(pl)
    ...
    for zz=1:length(zv)
        ...
        tolatex(fid,mtable,'%.2f',mntable,[c_prefix ' Mean (px)'],[l_prefix '_mean'],1);
        fprintf(fid,'\t\\newpage\n');
    end
end
...
for ii=1:length(pl)
    ...
    for zz=1:length(zv)
        ...
        tolatex(fid,mtable_,'%.2f',mntable_,[c_prefix ' Mean (px)'],[l_prefix '_mean'],2);
        fprintf(fid,'\t\\newpage\n');   
    end
end

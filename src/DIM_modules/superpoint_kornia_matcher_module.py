...
class superpoint_kornia_matcher_module:
    def __init__(self, **args):
        ...
        params = {
            ...
            "pipeline": "superpoint+kornia_matcher",
            "strategy": "bruteforce",
            "quality": "high",
            "tiling": "none",
    ...
    def get_id(self):
        return ('superpoint_kornia_matcher_th_' + str(self.th) + '_nfeat_' + str(self.nmax_keypoints)).lower()

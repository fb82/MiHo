...
def show_fig(im1, im2, pt1, pt2, Hdata, Hidx, tosave='miho_buffered_pytorch_gpu.pdf', fig_dpi=300,
...
class miho:
    ...
    def all_params():
        ...
        show_clustering_params = {'tosave': 'miho_buffered_pytorch_gpu.pdf', 'fig_dpi': 300,
             'colors': ['#FF1F5B', '#00CD6C', '#009ADE', '#AF58BA', '#FFC61E', '#F28522'],
             'markers': ['o','x','8','p','h'], 'bad_marker': 'd', 'bad_color': '#000000',
             'plot_opt': {'markersize': 2, 'markeredgewidth': 0.5,
                          'markerfacecolor': "None", 'alpha': 0.5}}

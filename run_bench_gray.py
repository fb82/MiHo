...
if __name__ == '__main__':    
    ...
    pipe_heads = [
        pipe_base.mast3r_module(upright=True, gray=True),
        pipe_base.roma_module(upright=True, gray=True), 
        pipe_base.lightglue_module(num_features=8000, upright=True, what='superpoint', gray=True),
        pipe_base.keypt2subpx_module(num_features=8000, upright=True, what='superpoint', gray=True),
        pipe_base.mast3r_module(upright=True),
        pipe_base.roma_module(upright=True), 
